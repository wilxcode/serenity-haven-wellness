        ...
        <div className="flex flex-col gap-16 max-w-[43.75rem]">
          <div className="flex flex-col gap-4">
            <FadeText
              ...
              text="Find Your Path to Inner Peace"
            />
            <FadeText
              ...
              text="At Serenity Haven Wellness, we offer a variety of therapeutic services designed to support your journey towards emotional well-being. Our experienced professionals are dedicated to helping you find the right path for your unique needs."
            />
          </div>
